# Graph Report - Invitaciones-BackendExpress  (2026-06-13)

## Corpus Check
- 66 files · ~22,809 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 572 nodes · 861 edges · 28 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9d93df6e`
...
6. `assertEffectivePlanFeature()` - 8 edges
7. `sendMail()` - 8 edges
8. `normalizePlan()` - 7 edges
9. `getPlanDefinition()` - 7 edges
10. `getPlanLimits()` - 7 edges
...
Cohesion: 0.10
Nodes (33): assert, event, guest, invitation, payload, text, whatsappService, activeProvider() (+25 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (26): connectDatabase(), env, mongoose, errorHandler(), notFound(), { connectDatabase }, Event, main() (+18 more)
...
Cohesion: 0.07
Nodes (19): { assertEffectivePlanFeature }, asyncHandler, crypto, env, Event, Guest, StaffAccessToken, asyncHandler (+11 more)
...
Cohesion: 0.09
Nodes (21): accessLinkBody, albumController, albumStatusBody, checkInController, checkInLinkBody, controller, eventBody, eventUpdateBody (+13 more)
...
Cohesion: 0.13
Nodes (16): controller, express, { protect }, router, { validate, z }, controller, express, router (+8 more)
...
Cohesion: 0.07
Nodes (24): AlbumAsset, { assertEffectivePlanFeature }, asyncHandler, buildPublicUrl(), env, Event, Guest, IMAGE_TYPES (+16 more)
...
Cohesion: 0.08
Nodes (21): asyncHandler, buildUniqueSlug(), emailService, env, Event, { getEffectivePlanLimits }, Guest, Invitation (+13 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (17): albumController, assetPayload(), asyncHandler, env, Event, Guest, publicEvent(), Rsvp (+9 more)
...
Cohesion: 0.20
Nodes (9): controller, express, identifyBody, multer, router, rsvpBody, songBody, upload (+1 more)
...
## Knowledge Gaps
- **340 isolated node(s):** `{ connectDatabase }`, `Event`, `User`, `{ planExpiresAt }`, `mongoose` (+335 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `{ z }` connect `Community 17` to `Community 0`, `Community 3`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `validate()` connect `Community 17` to `Community 0`, `Community 3`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
...
- **What connects `{ connectDatabase }`, `Event`, `User` to the rest of the system?**
